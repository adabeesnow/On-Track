...
$(document).ready(function () {
    for(numAdult = 1; numAdult <= 2; numAdult++) {
        number_of_adults = numAdult;
        for(numInfant = 0; numInfant <= 5; numInfant++) {
            number_of_infants = numInfant;
            if ((number_of_infants + number_of_preschoolers + number_of_schoolagers + number_of_teenagers) > 5) {
                continue;
            }
            for(numPreschooler = 0; numPreschooler <= 5; numPreschooler++) {
                number_of_preschoolers = numPreschooler;
                if ((number_of_infants + number_of_preschoolers + number_of_schoolagers + number_of_teenagers) > 5) {
                    continue;
                }
                for(numSchoolager = 0; numSchoolager <= 5; numSchoolager++) {
                    number_of_schoolagers = numSchoolager;
                    if ((number_of_infants + number_of_preschoolers + number_of_schoolagers + number_of_teenagers) > 5) {
                        continue;
                    }
                    for(numTeenager = 0; numTeenager <= 5; numTeenager++) {
                        number_of_teenagers = numTeenager;
                        if ((number_of_infants + number_of_preschoolers + number_of_schoolagers + number_of_teenagers) > 5) {
                            continue;
                        }
