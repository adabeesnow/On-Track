...
function ehcEITC() {
    ...
    if (numAdults() === 2 && numKids() === 0) {
        eitc_lookup_list = eitc_mfj_0_kids_amounts_list;
    }
    if (numAdults() === 2 && numKids() === 1) {
        eitc_lookup_list = eitc_mfj_1_kids_amounts_list;
    }
    if (numAdults() === 2 && numKids() === 2) {
        eitc_lookup_list = eitc_mfj_2_kids_amounts_list;
    }
    if (numAdults() === 2 && numKids() >= 3) {
        eitc_lookup_list = eitc_mfj_3_kids_amounts_list;
    }
    if (numAdults() === 1 && numKids() === 0) {
        eitc_lookup_list = eitc_single_0_kids_amounts_list;
    }
    if (numAdults() === 1 && numKids() === 1) {
        eitc_lookup_list = eitc_single_1_kids_amounts_list;
    }
    if (numAdults() === 1 && numKids() === 2) {
        eitc_lookup_list = eitc_single_2_kids_amounts_list;
    }
    if (numAdults() === 1 && numKids() >= 3) {
        eitc_lookup_list = eitc_single_3_kids_amounts_list;
    }
...
function ehcAdjustedChildTaxCredit() {
    ...
    return (((numAdults()===1&&ehc_gross_income<=75000))?ehcChildTaxCredit():(((numAdults()==1&&ehc_gross_income>75000&&((ehc_gross_income-75000)*0.05)>ehcChildTaxCredit()))?0:(((numAdults()==1&&ehc_gross_income>75000&&((ehc_gross_income-75000)*0.05)<=ehcChildTaxCredit()))?((ehc_gross_income-75000)*0.05):(((numAdults()==2&&ehc_gross_income<=110000))?ehcChildTaxCredit():(((numAdults()==2&&ehc_gross_income>110000&&((ehc_gross_income-100000)*0.05)>ehcChildTaxCredit()))?0:((ehc_gross_income-110000)*0.05))))));
