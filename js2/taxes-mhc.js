...
function mhcChildTaxCredit() {
    return mhcFederalTaxesOwedBeforeCredits() * child_tax_credit_each;
}
// Taxes	Q6
...
function mhcBenchmarkSilverPlan() {
    ...
    (num_infants + num_preschoolers + num_schoolagers + num_teenagers) > mhc_benchmark_silver_child_limit ?
        ...
        :
        (num_infants + num_preschoolers + num_schoolagers + num_teenagers)
        * mhc_benchmark_silver_child_each;
}
// Taxes	AA6
